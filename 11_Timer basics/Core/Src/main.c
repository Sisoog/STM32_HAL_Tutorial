...
#include "stdio_usart.h"	// Used for redirecting printf
#include <stdbool.h>
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint16_t counter = 0;									// Variable for measuring time
bool inrpt_sgnl_lvl = false, state_update = false;		// control flags
/* USER CODE END 0 */
